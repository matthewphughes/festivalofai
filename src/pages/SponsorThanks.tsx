...
const SponsorThanks = () => {
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Sponsor Pack Requested | Festival of AI</title>
      </Helmet>
      <Navigation />
      <div className="pt-32 pb-20 px-4">
        <div className="container mx-auto max-w-3xl text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-foreground mb-6">
            Thank You for Your <span className="text-primary">Interest</span>
          </h1>
          <div className="bg-card border border-border rounded-lg p-8 mb-8">
            <p className="text-xl text-foreground mb-6">Your sponsor pack request has been received!</p>
            <p className="text-muted-foreground mb-8">
              Our team will review your request and send you our comprehensive sponsor pack within 24 hours.
            ...
            <div className="border-t border-border pt-8">
              ...
              <p className="text-muted-foreground mb-6">Follow us on social media for the latest updates and announcements.</p>
